...
def getABPointsFromTwoCenters(ugrid_wall1,ugrid_wall2,verbose=True):

    if (verbose): print ('*** getABPointsFromTwoCenters ***')

    # Note that it is assumed here that the ventricle is vertical in the global coordinates system
    center1 = ugrid_wall1.GetCenter()
    center2 = ugrid_wall2.GetCenter()
    #print("bounds ="), bounds
    #print("center ="), center
    point_A = [center1[0], center1[1], center1[2]]
    point_B = [center2[0], center2[1], center2[2]]
    #print("point_A ="), point_A
    #print("point_B ="), point_B
    points_AB = vtk.vtkPoints()
    points_AB.InsertNextPoint(point_A)
